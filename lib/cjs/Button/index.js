...
const ButtonComponent = ({ children, className, label, pill, outline, disabled = false, size = 'md', icon: Icon, color = 'blue', positionInGroup, ...props }) => ((0, jsx_runtime_1.jsx)("button", { "data-testid": "button-element", disabled: disabled, className: (0, classnames_1.default)('group flex h-min w-fit items-center justify-center p-0.5 text-center font-medium focus:z-10', pill ? 'rounded-full' : 'rounded-lg', colorClasses[color], {
    ...
    }, className), type: "button", ...props, children: (0, jsx_runtime_1.jsx)("span", { className: (0, classnames_1.default)('flex items-center', sizeClasses[size], outline && pill ? 'rounded-full' : 'rounded-md', {
        ...
        }), children: Icon ? ((0, jsx_runtime_1.jsx)(Icon, { className: "h-5 w-5" }, void 0)) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [children, label && ((0, jsx_runtime_1.jsx)("span", { className: "ml-2 inline-flex h-4 w-4 items-center justify-center rounded-full bg-blue-200 text-xs font-semibold text-blue-800", children: label }, void 0))] }, void 0)) }, void 0) }, void 0));
