...
export const Alert = ({ children, color = 'blue', Icon, rounded = true, withBorderAccent, additionalContent, onDismiss, }) => {
    return (_jsxs("div", { className: classNames('flex flex-col gap-2 p-4 text-sm', colorClasses[color], {
            'rounded-lg': rounded,
            'border-t-4': withBorderAccent,
        }), role: "alert", children: [_jsxs("div", { className: "flex items-center", children: [Icon && _jsx(Icon, { className: "mr-3 inline h-5 w-5 flex-shrink-0" }, void 0), _jsx("div", { children: children }, void 0), onDismiss && (_jsxs("button", { type: "button", className: classNames('-mx-1.5 -my-1.5 ml-auto inline-flex h-8 w-8 rounded-lg p-1.5 focus:ring-2', {
                        ...
                        }), "aria-label": "Close", onClick: onDismiss, children: [_jsx("span", { className: "sr-only", children: "Close" }, void 0), _jsx(HiX, { className: "h-5 w-5" }, void 0)] }, void 0))] }, void 0), additionalContent && _jsx("div", { children: additionalContent }, void 0)] }, void 0));
};
